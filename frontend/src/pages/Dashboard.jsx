...
export default function Dashboard() {
  ...
  async function cargarDatos() {
    setCargando(true);
    try {
      // Cada request es independiente; si alguna falla, las demas igual cargan
  ...
  // Ventas por dia, ultimos 7 dias (para el grafico de barras)
  ...
  // Productos mas vendidos (a partir del detalle de cada venta)
